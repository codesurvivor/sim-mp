...
void sim_router_template::receive_packet()
{
	...
	add_type sor_network_addr;
	add_type des_network_addr;
	FindNetworkID(sor_addr_t, sor_network_addr);
	FindNetworkID(des_addr_t, des_network_addr);
	
	
	    packet_counter_++;
	    //inject_packet(/*packet_counter_*/msgNo, sor_addr_t, des_addr_t, local_input_time_, pack_size_t);
	    inject_packet(/*packet_counter_*/msgNo, sor_network_addr, des_network_addr, local_input_time_, pack_size_t, vc_s);
