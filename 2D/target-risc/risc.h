 ...
 * execute RISC (portable ISA) instructions.
 */
#include "smt.h"
/* build for RISC target */
#define TARGET_RISC

#ifndef TARGET_RISC_BIG
#ifndef TARGET_RISC_LITTLE
/* no cross-endian support, default to host endian */
#ifdef BYTES_BIG_ENDIAN
#define TARGET_RISC_BIG
#else
#define TARGET_RISC_LITTLE
#endif
#endif /* TARGET_RISC_LITTLE */
#endif /* TARGET_RISC_BIG */

/* probe cross-endian execution */
#if defined(BYTES_BIG_ENDIAN) && defined(TARGET_RISC_LITTLE)
#define MD_CROSS_ENDIAN
#endif
#if defined(BYTES_LITTLE_ENDIAN) && defined(TARGET_RISC_BIG)
#define MD_CROSS_ENDIAN
#endif
...
enum md_reg_names {
  ...
  MD_REG_V0 = 2,	/* return value reg */
  //MD_REG_ERR = 7,
  MD_REG_A0 = 4,	/* argument regs */
  MD_REG_A1 = 5,
  MD_REG_A2 = 6,
  MD_REG_A3 = 7,
  MD_REG_A4 = 8,
  MD_REG_A5 = 9,
  MD_REG_RA = 31	/* return address reg */
};
...
#define RC		((inst >> 11) & 0x1f)		/* reg dest */
...
#define FS		RD
#define FT		RT
#define FD		((inst >> 6) & 0x1f)		/* freg dest */
...
/******************************************************************************/
#define GETANYBITS(startbit,mask)     (((inst) >> (startbit)) & (mask))

#define SA    GETANYBITS(6,0x1f)
